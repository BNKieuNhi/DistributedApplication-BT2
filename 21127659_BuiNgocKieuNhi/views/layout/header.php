...
<div class="container">
    <header class="nav-container">
        <div class="nav-left">
            <img src="/DistributedSystem/21127659_BuiNgocKieuNhi/assets/images/smile-2_removebg.png" alt="Smile.png" class="nav-header__logo">
        ...
        <div class="nav-items">
            ...
            <a class="nav-item" href="index.php?action=search">Search</a>
        </div>
        <div class="nav-right">
